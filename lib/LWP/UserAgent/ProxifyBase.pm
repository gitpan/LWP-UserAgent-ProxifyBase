package LWP::UserAgent::ProxifyBase;
...
LWP::UserAgent::ProxifyBase - base class for LWP::UserAgent based modules which want to proxy-hop their requests
...
=head1 SYNOPSIS
    ...
    use base 'LWP::UserAgent::ProxifyBase';
...
as LWP::UserAgent::Proxify (note the suspiciously short synopsys HAR)
but I figured it would be more useful as a base class.

=head1 WHAT'S IN IT?

By adding C<use base 'LWP::UserAgent::ProxifyBase';> to your code it should
...
Please report any bugs or feature requests to C<bug-lwp-useragent-proxifybase at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=LWP-UserAgent-ProxifyBase>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc LWP::UserAgent::ProxifyBase
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=LWP-UserAgent-ProxifyBase>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/LWP-UserAgent-ProxifyBase>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/LWP-UserAgent-ProxifyBase>

=item * Search CPAN

L<http://search.cpan.org/dist/LWP-UserAgent-ProxifyBase>
